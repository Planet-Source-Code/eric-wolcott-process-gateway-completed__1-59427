...
Begin VB.UserControl UserControl4 
   ...
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   191
   Begin ProcessGateway.TrackMouse TrackMouse1 
      Index           =   0
      Left            =   1560
      Top             =   1920
      _ExtentX        =   741
...
Dim Color_Cap As String

Dim Color_Cent As String

Dim Color_Corner As String
...
If SelectedOption = index Then Exit Sub
Dim htext As String
Dim lentext As Long
Dim vh As Integer
Dim hrect As RECT
...
Function forceClick(index As Integer)
    Call TrackMouse1_MouseLeftDown(index)
End Function
